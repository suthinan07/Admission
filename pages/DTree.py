...
st.set_page_config(page_title="ข้อมูลการรับเข้าศึกษาต่อในมหาวิทยาลัย📊Dtree", page_icon="❤️")

# --- Header Section ---
st.title("ข้อมูลการรับเข้าศึกษาต่อในมหาวิทยาลัย📊ด้วย Decision Tree")
st.markdown("---")
st.markdown("แอปพลิเคชันนี้ใช้โมเดล *Decision Tree* ในการวิเคราะห์ข้อมูลการรับเข้าศึกษาต่อในมหาวิทยาลัย📊")
...
try:
    ...
    st.info("✅ โหลดข้อมูลจากไฟล์ *'data1.csv'* เรียบร้อยแล้ว")
